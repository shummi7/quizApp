...
class QuizQueAns extends React.Component{
    ...
    onQuestionAnswerLoad=(index_arg)=>{
        ...
        const correctAns=decode_entities(this.state.quizArray[index].correct_answer);
...
<div>
    ...
    <div id='queAnsSection' className='queAnsSection'>
        ...
        <p>SCORE</p>
        <p>Right Answers: <span>{this.state.right}</span></p>
        <p>Wrong Answers: <span>{this.state.wrong}</span></p>
        <p>{this.state.score}</p>
        <button className='restart' onClick={()=>this.props.onRouteChange('optionPage')}>Restart</button>
        <button onClick={()=>this.props.onRouteChange('profilePage')}>Profile</button>
        </div>
 
        <div className='answers'>
            <div className='centerHor items'>
            <button className='button' id='bu1' onClick={()=>this.buttonClick('bu1')}>{this.state.answer1}</button>
            <button className='button' id='bu2' onClick={()=>this.buttonClick('bu2')}>{this.state.answer2}</button>
            </div>

            <div className='centerHor items'>
            <button className='button' id='bu3' onClick={()=>this.buttonClick('bu3')}>{this.state.answer3}</button>
            <button className='button' id='bu4' onClick={()=>this.buttonClick('bu4')}>{this.state.answer4}</button>
            </div>
        </div>
